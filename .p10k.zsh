# Generated by Powerlevel10k configuration wizard on 2025-05-30 at 11:41 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_BACKGROUND="#32302f"
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta="%244F" # white foreground 
      local      clean="%3F" # black foreground 
      local   modified="%2F" # black foreground 
      local  untracked="%1F" # black foreground 
      local conflicted='%196F' # red foreground 
    else
  ...
  ################[ pyenv: python environment (https://github.com/pyenv/pyenv) ]################
  # Pyenv color.
  typeset -g POWERLEVEL9K_PYENV_FOREGROUND=$purple
